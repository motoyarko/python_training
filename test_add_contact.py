...
class test_add_contact(unittest.TestCase):
    ...
    def test_test_add_contact(self):
        ...
        wd.find_element_by_name("photo").send_keys("C:\\Users\\motoy\\Downloads\\Starinnyi-velosiped-s-bol1shim-perednim-kolesom.jpg")
        ...
        wd.find_element_by_name("fax").send_keys("faxTelephone")
        wd.find_element_by_name("email").click()
        wd.find_element_by_name("email").send_keys("email1@email.com")
        ...
        if not wd.find_element_by_xpath("//div[@id='content']/form/select[5]//option[5]").is_selected():
